/**
 * This is a React component that renders a footer with information about the developer and links to
 * social media profiles.
 * @returns A React functional component that renders a footer section with contact information and
 * social media links.
 */
          ...
          <section>
            <div className="row">
              <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p>
                  This CV show the skills of Reactjs with HTML CSS JAVASCRIPT
                  BOOTSTARP
                </p>
              </div>
